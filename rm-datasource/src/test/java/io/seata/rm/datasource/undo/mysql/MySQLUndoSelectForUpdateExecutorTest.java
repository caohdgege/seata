 ...
 * @author chd
 */
public class MySQLUndoSelectForUpdateExecutorTest extends BaseExecutorTest {
    private static MySQLUndoSelectForUpdateExecutor executor;
    private static TableMeta tableMeta;

    @BeforeAll
    public static void init(){
        TableMeta tableMeta = MySQLUndoSelectForUpdateExecutorTest.tableMeta = Mockito.mock(TableMeta.class);
        ...
        executor = new MySQLUndoSelectForUpdateExecutor(sqlUndoLog);
    }
