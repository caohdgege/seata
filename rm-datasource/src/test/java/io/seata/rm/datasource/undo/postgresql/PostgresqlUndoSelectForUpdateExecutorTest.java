 ...
 * @author chd
 */
public class PostgresqlUndoSelectForUpdateExecutorTest extends BaseExecutorTest {

    private static PostgresqlUndoSelectForUpdateExecutor executor;
    private static TableMeta tableMeta;

    @BeforeAll
    public static void init(){
        TableMeta tableMeta = PostgresqlUndoSelectForUpdateExecutorTest.tableMeta = Mockito.mock(TableMeta.class);
        ...
        executor = new PostgresqlUndoSelectForUpdateExecutor(sqlUndoLog);
    }
