...
public class PreparedStatementProxyTest {
    ...
    public void testGetSetParamsByIndex() {
        ...
        Assertions.assertEquals("xxx",  preparedStatementProxy.getParamsByIndex(1));
    }
    ...
    public void testSetParam() throws SQLException, MalformedURLException {
        ...
        Assertions.assertEquals(Null.get(), preparedStatementProxy.getParamsByIndex(1));
        preparedStatementProxy.clearParameters();
        ...
        Assertions.assertEquals(true, preparedStatementProxy.getParamsByIndex(1));
        preparedStatementProxy.clearParameters();

        preparedStatementProxy.setByte(1, (byte)0);
        Assertions.assertEquals((byte)0, preparedStatementProxy.getParamsByIndex(1));
        preparedStatementProxy.clearParameters();

        preparedStatementProxy.setShort(1, (short)0);
        Assertions.assertEquals((short)0, preparedStatementProxy.getParamsByIndex(1));
        preparedStatementProxy.clearParameters();

        preparedStatementProxy.setInt(1, 0);
        Assertions.assertEquals(0, preparedStatementProxy.getParamsByIndex(1));
        preparedStatementProxy.clearParameters();

        preparedStatementProxy.setLong(1, 0L);
        Assertions.assertEquals(0L, preparedStatementProxy.getParamsByIndex(1));
        preparedStatementProxy.clearParameters();

        preparedStatementProxy.setFloat(1, 0f);
        Assertions.assertEquals(0f, preparedStatementProxy.getParamsByIndex(1));
        preparedStatementProxy.clearParameters();

        preparedStatementProxy.setDouble(1, 1.1);
        Assertions.assertEquals(1.1, preparedStatementProxy.getParamsByIndex(1));
        preparedStatementProxy.clearParameters();

        preparedStatementProxy.setBigDecimal(1, new BigDecimal(0));
        Assertions.assertEquals(new BigDecimal(0), preparedStatementProxy.getParamsByIndex(1));
        preparedStatementProxy.clearParameters();

        preparedStatementProxy.setString(1, "x");
        Assertions.assertEquals("x", preparedStatementProxy.getParamsByIndex(1));
        preparedStatementProxy.clearParameters();
        ...
        Assertions.assertTrue(Objects.deepEquals("x".getBytes(), preparedStatementProxy.getParamsByIndex(1)));
        preparedStatementProxy.clearParameters();

        Date date = new Date(System.currentTimeMillis());
        preparedStatementProxy.setDate(1, date);
        Assertions.assertEquals(date, preparedStatementProxy.getParamsByIndex(1));
        preparedStatementProxy.clearParameters();
        ...
        Assertions.assertEquals(time, preparedStatementProxy.getParamsByIndex(1));
        preparedStatementProxy.clearParameters();
        ...
        Assertions.assertEquals(timestamp, preparedStatementProxy.getParamsByIndex(1));
        preparedStatementProxy.clearParameters();
        ...
        Assertions.assertEquals(byteArrayInputStream, preparedStatementProxy.getParamsByIndex(1));
        preparedStatementProxy.clearParameters();
        ...
        Assertions.assertEquals(1, preparedStatementProxy.getParamsByIndex(1));
        preparedStatementProxy.clearParameters();
        ...
        Assertions.assertEquals(charArrayReader, preparedStatementProxy.getParamsByIndex(1));
        preparedStatementProxy.clearParameters();
        ...
        Assertions.assertEquals(ref, preparedStatementProxy.getParamsByIndex(1));
        preparedStatementProxy.clearParameters();

        MockBlob blob = new MockBlob();
        preparedStatementProxy.setBlob(1, blob);
        Assertions.assertEquals(blob, preparedStatementProxy.getParamsByIndex(1));
        preparedStatementProxy.clearParameters();
        ...
        Assertions.assertEquals(clob, preparedStatementProxy.getParamsByIndex(1));
        preparedStatementProxy.clearParameters();
        ...
        Assertions.assertEquals(nclob, preparedStatementProxy.getParamsByIndex(1));
        preparedStatementProxy.clearParameters();
        ...
        Assertions.assertEquals(array, preparedStatementProxy.getParamsByIndex(1));
        preparedStatementProxy.clearParameters();
        ...
        Assertions.assertEquals(url, preparedStatementProxy.getParamsByIndex(1));
        preparedStatementProxy.clearParameters();

        MockSQLXML sqlxml = new MockSQLXML();
        preparedStatementProxy.setSQLXML(1, sqlxml);
        Assertions.assertEquals(sqlxml, preparedStatementProxy.getParamsByIndex(1));
        preparedStatementProxy.clearParameters();
